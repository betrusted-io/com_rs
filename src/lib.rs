...
// WLAN interrupt mask bits
// set when an Rx packet is ready. Argument is length of packet.
pub const WLAN_INT_RX_READY: u16      = 0b0000_0000_0000_0001;
// set when IP configuration has been updated and should be read out. Generated by the DHCP engine.
pub const WLAN_INT_IPCONF_UPDATE: u16 = 0b0000_0000_0000_0010;
// set when SSID scan has new data.
pub const WLAN_INT_SSID_UPDATE: u16   = 0b0000_0000_0000_0100;
